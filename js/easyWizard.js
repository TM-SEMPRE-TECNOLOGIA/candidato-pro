$.fn.wizard = function (config) {
  ...
  var exitText = config.exit || "<img width='100%' src='imagens/icon2.svg'>";
  var backText = config.back || "<img width='100%' src='imagens/icon2.svg'>";
  var nextText = config.next || "<img width='100%' src='imagens/icon1.svg'>";
  var finishText =
    config.finish || "<img width='100%' src='imagens/icon1.svg'>";
  ...
  container.prepend(
    '<div class="wizard-steps-panel steps-quantity-' + stepCount + '"></div>'
  );
  ...
  var btns = "";
  btns +=
    '<button type="button" class="btn btn-default button2 wizard-button-exit"' +
    contentForModal +
    ">" +
    exitText +
    "</button>";
  btns +=
    '<button type="button" class="btn btn-default button2 wizard-button-back">' +
    backText +
    "</button>";
  btns +=
    '<button type="button" class="btn btn-default button2 wizard-button-next">' +
    nextText +
    "</button>";
  btns +=
    '<button type="button" class="btn btn-primary button2 wizard-button-finish" ' +
    contentForModal +
    ">" +
    finishText +
    "</button>";
